// lib/screens/dashboards/court_dashboard.dart
// Court official dashboard — primary user of Risk Intelligence
...
class _CourtDashboardState extends State<CourtDashboard>
  ...
  Widget build(BuildContext context) {
    ...
    final rate = total > 0
        ? '${((anc / total) * 100).toStringAsFixed(1)}%'
        : '0%';
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          FadeSlide(
            ...
            child: WelcomeBanner(
              ...
              role: 'court',
              subtitle:
              'Court Official  ·  Review evidence · Monitor risk intelligence · Verify integrity',
              stats: {
  ...
  Widget _actSec(DC C) => FadeSlide(
    ...
    child: GlassCard(
      ...
      child: Column(
          ...
          children: [
            _h('Recent Activity', Icons.history_rounded,
  ...
  Widget _actionsSec(DC C) => FadeSlide(
    ...
    child: GlassCard(
      ...
      child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _h('Court Actions', Icons.account_balance_outlined,
                const Color(0xFFD97706)),
            const SizedBox(height: 12),
            ActionCard(
              C: C,
              label: 'Risk Intelligence',
              sub: 'Anomaly detection & alerts',
              icon: Icons.shield_outlined,
            ...
            ActionCard(
              C: C,
              label: 'Review All Evidence',
              sub: 'Full case inventory',
              icon: Icons.account_balance_outlined,
              color: const Color(0xFFD97706),
              onTap: () => _go(EvidenceListScreen(filterByCaseId: null)),
            ),
            ...
            ActionCard(
              C: C,
              label: 'View Custody Chain',
              sub: 'Complete transfer history',
              icon: Icons.timeline_outlined,
              color: const Color(0xFF7C3AED),
